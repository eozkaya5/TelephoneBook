...
namespace TelephoneBook.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TelephoneBookDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TelephoneBookEfCoreEntityExtensionMappings to extend the IdentityUser entity
